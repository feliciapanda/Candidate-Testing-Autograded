...
function gradeQuiz(candidateAnswers) {
  ...
  let grade = correctAnswerNum / questions.length * 100;  //TODO 3.2 use this variable to calculate the candidates score.
  console.log(grade);
  if (grade >= 80) {
    console.log(`Your score is ${grade}, you have passed the test`);
  } else {
    console.log(`Your score is ${grade}, you have failed the test`);
  }
  return grade;
}
function runProgram() {
